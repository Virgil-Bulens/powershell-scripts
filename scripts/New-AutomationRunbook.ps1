...
{
    # Variables
    $templateUrl = "https://raw.githubusercontent.com/Virgil-Bulens/powershell-scripts/refs/heads/main/templates/automationRunbookTemplate.ps1"
...
process
{
    try 
    {
        ...
        $Content = Invoke-RestMethod -Uri $templateUrl
